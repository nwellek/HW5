...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://localhost/nwellekHW5"
...
def send_email(to, subject, template, **kwargs): # kwargs = 'keyword arguments', this syntax means to unpack any keyword arguments into the function in the invocation...
	...
	thr.start()
	return thr # The thread being returneds
#########
...
# TODO: You will need to make changes in this function as well, to address users having emails. See above. What do you need to change to make sure get_or_create_user is *invoked* correctly,
# including saving an email? Does anything need to change about the input to get_or_create_tweet, and *its* invocations?
